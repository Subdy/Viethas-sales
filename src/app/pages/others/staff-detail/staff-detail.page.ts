...
export class StaffDetailPage implements OnInit {
  ...
  public trigger_popup: boolean;
  public item: any;
  public edit_item_form: FormGroup;
  public collection: string
  public modalName: string = "hhhhhhh";
  public successMessage = "erroooooo";
  public date: any;
  public variable: string = "Name";
  public img: any;
  public id_employees:string;
  ...
  constructor(
    ...
    this.img='https://ggstorage.oxii.vn/images/oxii-2019-2-26/728/hot-girl-waralee-ngot-hon-duong-trong-bo-anh-sun-set-anh-7_1.jpg';
  ...
  ngOnInit() {
    ...
    this.id_employees = this.item.id;
...
updateMyDate($event) {
  ...
  cancel(){
    this.trigger_popup = false;
    console.log("cancel delete! ", this.id_employees);
  }


  deteleSupplier(){
    console.log("id_employees: ", this.id_employees);
    this.firebaseAuth.deleteEmployee(this.id_employees)
    .then(res => {
      console.log(res);
    }, err => {
      console.log("Gap loi ko the xoa: ",err);       
    })
    this.trigger_popup = false;
  }
