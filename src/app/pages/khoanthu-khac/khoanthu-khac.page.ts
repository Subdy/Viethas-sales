...
@Component({
  selector: 'app-khoanthu-khac',
  templateUrl: './khoanthu-khac.page.html',
  styleUrls: ['./khoanthu-khac.page.scss']
})
export class KhoanthuKhacPage implements OnInit {
  private user_info;
  ...
  onSubmit(form) {
    ...
    data["bill_type"] = 7; // Add bill type
